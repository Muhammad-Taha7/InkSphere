...
export const LatestBlogs = () => {
  ...
  return (
    <section className="w-full bg-white px-6 py-24 border-t border-gray-100">
      {/* Title Header */}
        ...
        <div className="mx-auto grid max-w-[1600px] grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {blogs.map((blog, index) => (
            <Link
              key={blog._id}
              to={`/blogs/${blog._id}`}
              className="group flex flex-col overflow-hidden rounded-xl bg-white border border-gray-100 shadow-sm transition-all duration-300 hover:-translate-y-2 hover:border-yellow-400/50 hover:shadow-lg"
            >
              {/* Image */}
              ...
              <div className="flex flex-1 flex-col p-6">
                ...
                <h3 className="mb-3 font-serif text-xl font-bold leading-snug text-gray-900 transition-colors group-hover:text-yellow-600">
                  {blog.title}
                </h3>
                ...
                {/* Footer Stats */}
                <div className="mt-auto flex items-center gap-4 border-t border-gray-100 pt-4 text-xs font-semibold text-gray-400">
                  <span className="flex items-center gap-1.5 transition-colors group-hover:text-gray-900">
