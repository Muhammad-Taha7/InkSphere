...
export const Home = () => {
    return (
        <div className="bg-white dark:bg-zinc-950 text-gray-900 dark:text-zinc-100 transition-colors duration-300">
            {/* Hero Section */}
            <section className="relative min-h-[90vh] w-full overflow-hidden bg-white dark:bg-zinc-950 px-6 py-20 text-gray-900 dark:text-zinc-100 md:px-12 lg:px-20 flex flex-col justify-center transition-colors duration-300">
                ...
                <div className="relative z-10 mx-auto max-w-[1600px] w-full">
                    ...
                    <div className="mb-16 flex flex-col items-center justify-center gap-6 text-center">
                        <div className="flex items-center gap-2 rounded-full border border-yellow-400 bg-yellow-50 dark:bg-yellow-950/20 px-4 py-1.5">
                            <Sparkles className="h-4 w-4 text-yellow-500" />
                            <span className="text-xs font-bold uppercase tracking-[0.2em] text-yellow-600 dark:text-yellow-400">Discover InkSphere</span>
                        </div>

                        <h1 className="max-w-5xl font-serif text-5xl font-black leading-[1.1] tracking-tight text-gray-900 dark:text-white sm:text-7xl lg:text-[7rem]">
                    ...
                    <div className="grid grid-cols-1 gap-6 lg:grid-cols-12 lg:h-[600px]">
                        ...
                        {/* Call to Action Box */}
                        <div className="col-span-1 flex flex-col justify-between rounded-2xl border border-gray-200 dark:border-zinc-800 bg-gray-50 dark:bg-zinc-900/30 p-8 lg:col-span-4 lg:p-12 transition-colors hover:border-yellow-400">
                            
                            <div>
                                <div className="mb-6 h-12 w-12 rounded-full bg-yellow-100 dark:bg-yellow-950/30 flex items-center justify-center">
                                    <svg className="h-6 w-6 text-yellow-600 dark:text-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                                    </svg>
                                </div>
                                <h3 className="mb-4 font-serif text-2xl font-bold text-gray-900 dark:text-white md:text-3xl">
                                    Start Your Journey
                                </h3>
                            ...
                            <div className="mt-12 space-y-4">
                                ...
                                <Link to="/blogs" className="block w-full rounded-xl border border-gray-300 dark:border-zinc-700 bg-transparent px-6 py-4 text-center text-sm font-bold text-gray-900 dark:text-zinc-150 transition-all hover:bg-gray-100 dark:hover:bg-zinc-800">
                                    EXPLORE ARTICLES
                                </Link>
                            </div>
