...
export const Notifications = () => {
  ...
  const fetchNotifications = async () => {
    try {
      ...
      const { data } = await axios.get(`https://ink-sphere-backend-ukrx.vercel.app/api/notifications`, config);
  ...
  const markAsRead = async (id) => {
    try {
      ...
      await axios.put(`https://ink-sphere-backend-ukrx.vercel.app/api/notifications/${id}/read`, {}, config);
  ...
  const markAllAsRead = async () => {
    try {
      ...
      await axios.put(`https://ink-sphere-backend-ukrx.vercel.app/api/notifications/read-all`, {}, config);
